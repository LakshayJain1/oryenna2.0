...
export default function AuthPage() {
    ...
    const handleSubmit = (e: React.FormEvent) => {
        ...
        setSubmitting(true);
        setSubmitText(
            mode === "signin" ? "Authenticating Presence..." : "Sending Link..."
        );
        setTimeout(() => {
            setSubmitText(
                mode === "signin" ? "Welcome Back." : "Link Dispatched to Inbox."
            );
            setTimeout(() => {
                setSubmitting(false);
                setSubmitText(
                    mode === "signin" ? "Enter Your Sanctuary" : "Transmit Sensory Link"
                );
            }, 2200);
        }, 1200);
    };
